 ...
 * <p>
 * You can customize the conditions how often and how long the task is executed using the methods in this interface, before calling any of the methods from {@link Promisable} or {@link Subscription}.
 *
...
public interface Repeat<C extends FlowContext> extends Promisable<C>, Subscription<C> {
    ...
    /**
     * Whether the execution of {@linkplain Task tasks} should fail fast or fail last. Defaults to {@value Repeat#DEFAULT_FAIL_FAST}.
     */
